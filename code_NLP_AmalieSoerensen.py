...
from sklearn.metrics import confusion_matrix, balanced_accuracy_score, classification_report, accuracy_score, recall_score, precision_score
...
df['Parti_b'] = df['Parti'].replace({'Det_Konservative_Folkeparti': 0})
df['Parti_b'] = df['Parti'].replace({'Dansk_Folkeparti': 0})
df['Parti_b'] = df['Parti'].replace({'Radikale_Venstre': 0})
df['Parti_b'] = df['Parti'].replace({'Venstre': 0})
df['Parti_b'] = df['Parti'].replace({'Socialdemokratiet': 1})
df['Parti_b'] = df['Parti'].replace({'Socialistisk_Folkeparti': 1})
df['Parti_b'] = df['Parti'].replace({'Liberal_Alliance': 0})
df['Parti_b'] = df['Parti'].replace({'Enhedslisten': 1})
df['Parti_b'] = df['Parti'].replace({'Alternativet': 1})
